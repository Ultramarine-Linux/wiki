...
---
<Callout>
You may have noticed package manager tags (like this<sup>dnf</sup> and this<sup>flatpak</sup>) across the wiki. This shows our reccomended way to get that software, either from `dnf` or as a `flatpak`.
