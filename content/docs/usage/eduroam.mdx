...
If you need further support, we recommend contacting your institution's helpdesk, or hopping into one of [our chats](/docs/community/).

### eduroam Tips
- Many insutitions require users from other institutions to use CAT, if you followed this guide you're already good to go
- If your institution uses SSO credentials for eduroam, you will need to repeat this guide when you reset your password
- Your device will automatically connect to eduroam at any institution offering it
