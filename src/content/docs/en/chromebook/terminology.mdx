...
Usually refers to Firmware Write Protect (FW_WP) or Hardware Write Protect. A feature of Chromebooks that marks a region of the ROM that holds firmware as read-only. It is possible (and rather easy) to remove the protection on most Chromebooks. [1]
...
Allows Chromebooks with cr50 to disable WP without opening the device. This requires a special device called suzyQ. Fyra Labs sells a [SuzyQ Board](https://developer.fyralabs.com/suzyqboard), or you can build one yourself. [1] [2]
