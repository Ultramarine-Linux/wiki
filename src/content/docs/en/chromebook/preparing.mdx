...
<Alert type="info">
  If you choose to back up with Google Drive, you will be prompted to add your
  Google Drive to the Ultramarine Chromebook file explorer during setup to
  easily access and redownload your data.
</Alert>
...
4. You should have an output saying 'SUCCESS: Booting and self-assigned kernel from SSD/USB/SDCard slot in enabled.' You are now ready for step 4.
...
4. After Ultramarine Chromebook is fully installed, and it prompts you to reboot, you may safely remove your installer.
