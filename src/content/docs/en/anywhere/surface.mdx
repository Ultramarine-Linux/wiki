...
| Surface Book                 | Yes                     | Also needs Nvidia drivers, fans may not work                                                                                                       | ✓             |
| Surface Book 2               | Yes                     | Also needs Nvidia drivers, fans may not work                                                                                                       | ✓             |
| Surface Book 3               | Yes                     | Also needs Nvidia drivers. Additionally, surface_aggregator and associated kernel modules NEED to be in initramfs                                  |               |
