...
To enable the camera functionality on current Surface images, you need to add your user to the video group. Future Surface images with the Taidan out-of-box applicaion will add your user to this group for you. To add yourself to the video group:
