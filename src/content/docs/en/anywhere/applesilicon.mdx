...
We are steadlily working on porting the Asahi Linux installer to work with Ultramarine. Images that can boot from Asahi UEFI (using the Asahi kernel) are actively being worked on as well.
