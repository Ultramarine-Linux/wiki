...
<Alert type="info">
  Fyra Labs/Ultramarine and ASUS Linux are both a part of the Open Gaming Collective and are working on centralizing all needed ROG patches into an Open Gaming Collective kernel.
...
- [supergfxctl](https://gitlab.com/asus-linux/supergfxctl) - Please note, this package is being deprecated and is generally not needed (except to access vfio, eGPU etc.).
