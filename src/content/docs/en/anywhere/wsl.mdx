...
It is possible to install and run graphical Linux applications, and even full desktop environments. We plan to make running a desktop environment through Ultramarine WSL easier in the near future.

## System Requirements

WSL2, and by extension Ultramarine WSL, needs the following:

- Windows 10 (Version 2004 Build 19041), or Windows 11. Note IPv6 spport requires Windows 11.
...
It is always reccomended to update a fresh system. To do this, please run the following command:
