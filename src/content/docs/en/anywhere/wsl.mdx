...
```
curl https://images.fyralabs.com/images/ultramarine/42/ports-wsl-wsl-x86_64.tar.gz -o ultramarine.wsl; wsl --install --from-file ultramarine.wsl
```

For aarch64 users:

```
curl https://images.fyralabs.com/images/ultramarine/42/ports-wsl-wsl-aarch64.tar.gz -o ultramarine.wsl; wsl --install --from-file ultramarine.wsl
```
