...
<Alert type="info">
  You do NOT need to resize the root filesystem, it should do this automatically upon first boot. Depending on the size of your Chromebook's internal storage, you may need to move the Submarine partiiton to the end of the disk again, after it is copied to internal.
</Alert>
