...
8. Once the `dd` is done, verify the Submarine partition shows 'ChromeOS Kernel' as a flag on the internal disk. We reccomend using GParted for this (dnf install gparted).
