...
6. Use `dd` to copy the contents of the USB/SD card to the internal storage of the Chromebook. (Note, you do NOT need to resize the root filesystem, it should do this automatically upon first boot).
