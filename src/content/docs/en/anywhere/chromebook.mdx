...
2. Create a 16 MB ext4 partition at the END of the disk (for proper resizing after installation). In gparted, accomplish this by making a new partition in the unallocated space, and dragging it all the way to the right while still in the 'Create new Partition' menu. If gparted gives you a 'Libparted Warning,' select 'Fix.'
