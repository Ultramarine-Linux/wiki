...
You can also click on the `Advanced` button for a more in-depth configuration of your account, such as your user folder location, your account ID, and your group membership.
