...
With Ultramarine 41 we are now providing a formal preview of our bootc variant. Ultramarine bootc is based on Fedora bootc, but we intend to switch to our own base container (based on Fedora packages) in the future.
Bootc. We see this as the future of Linux systems. Ideally, this will become our standard edition in the future.

These builds are currently in beta. If you are planning to test them, please join our [Discord](https://fyralabs.com/discord) or [Matrix](https://fyralabs.com/matrix) community first and let us know. We'll be happy to receive feedback and assist you.
...
Ultramarine is available for almost all x86 ChromeOS devices. See the [Chromebook Edition section](/en/chromebook/chromebook) for more information.
