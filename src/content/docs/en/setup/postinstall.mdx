...
<Alert type="info">
  The automatic installation of extra drivers does **not** cover all hardware
  and may not work on some systems, and is only included in the live
  environment. If you are having trouble with the drivers, you can install them
  manually using the commands above.
</Alert>
...
#### [Next Up: Advanced Post-Install Scripts →](/en/setup/post-advanced)
