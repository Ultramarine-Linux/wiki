...
**Lapis Edition** is an OSTree variant of Ultramarine Linux, which works similarly to Fedora Silverblue, CoreOS and other OSTree-based operating systems. This variant is made for users who want a stable, immutable system that is easy to recover from.
