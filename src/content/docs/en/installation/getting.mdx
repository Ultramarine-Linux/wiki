...
If your computer could run Windows 8.1, chances are it'll run Ultramarine Linux. You should check the [System Requirements](/en/hardware/requirements) to make sure
...
With Ultramarine 41 we are now providing a formal preview of our atomic variant. Ultramarine Atomic is based on Fedora bootc, but we intend to switch to our own base container (based on Fedora packages) in the future.
Bootc, and atomicity generally still has some papercuts, but things move fast. We see this as the future of Linux systems. Ideally, this will become our standard edition in the future.

These builds are currently in beta. If you are planning to test them, please join [one of our chats](/en/community/community) first and let us know. We'll be happy to receive feedback and assist you.

[Try Ultramarine Atomic →](https://ultramarine-linux.org/download/atomic-preview)
...
<Alert type="info">
  If you're currently using Linux, you may be able to enter setup by running
