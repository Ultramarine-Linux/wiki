...
These can be found in the [Raw Image](https://ultramarine-linux.org/download/raw) sections of the download page.
...
<Alert type="info">
  If you're using a Raspberry Pi or Chromebook. Stop here and go to the
  [Raspberry Pi instructions](/en/installation/rpi) or [Chromebook
  instructions](/en/chromebook/preparing).
</Alert>
