...
We see OSTree as the future of Linux systems. Ideally this will become the standard edition in the future.
...
[Try Ultramarine OSTree →](https://nightly.link/Ultramarine-Linux/ostree-config/workflows/ci-isos.yaml/main?preview)
