...
If you're more of a gambler and want to play games from miHoYo/HoYoverse, their games are not officially supported on Linux due to anti-cheat software. However, there are current efforts to circumvent these restrictions. You can find more information on the [Launcher.moe Wiki](https://docs.launcher.moe/).


<Alert type="warning">

Fyra Labs is not responsible for legal or in-game retalition from miHoYo, Cognosphere (dba "HoYoverse") or it's affiliates for cheating, being falsely-flagged as a cheater, or any other reason due to use of these tools to remove DRM protections from their games. Information provided in this document and by Launcher.moe is for educational purposes only. Launcher.moe is not affilated with Fyra Labs. All Rights Reserved.
...
| Game               | Status                           |
| ------------------ | -------------------------------- |
| Honkai Impact 3rd  | Playable                         |
| Anime Game         | Playable                         |
| Honkai: Star Rail  | Playable, unstable               |
| ZZZ                | Unreleased                       |