...
If you install the Steam RPM, you may get this error when trying to open Steam:
...
You can fix this by installing the needed packages:

```shell
sudo dnf install libglvnd-glx.i686 libnsl.i686
```
...
#### [← Back To: Ultramarine Anywhere, Raspberry Pi](/en/anywhere/rpi)
