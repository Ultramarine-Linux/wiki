...
currently half of the project team speaks something other than English natively. This page
contains details on how i18n works and how it can be set up on Ultramarine.
...
2. When Fcitx 5 is running, right click on the new "en" icon on the system tray > Settings.
3. Start configuring Fcitx5.

## Setting up IBus

1. Install your chosen IMEs (see the table below).
2. On Gnome (or similar DEs), go into Settings > Keyboard.
