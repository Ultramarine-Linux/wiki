...
After you've tested, it's time to contribute. Simply open a pull request to the appropiate repository and we'll review it. Make sure your pull request is descriptive, outlining the motivation, scope, and implementation of your changes.
