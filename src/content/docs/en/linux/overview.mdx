...
Linux is an open-source kernel, which can be used to build an operating system. A kernel is the core of the system and provides an interface between programs and hardware. Ultramarine itself is built on Linux.

Linux itself is not a complete operating system in itself. It is a kernel, or the core of an operating system. Linux itself is usually packaged along with the GNU operating system, which is a collection. This packaged system is often referred to as GNU/Linux, or Linux for short.
