...
Linux is an open-source kernel, which can be used to build an operating system. A kernel is the core of the system and provides an interface between programs and hardware. Ultramarine itself built on Linux.
