...
| /boot     | The bootloader and files used during early boot process. May usually be in a separate partition.                                                                                  |
...
#### [← Back To: Concepts](/en/linux/overview)

#### [Next Up: Device Files →](/en/linux/devicefiles)
