...
In Linux, everything is a file. Unlike Windows where many other object types can either be a physical device, and inter-process communication is done by a kernel call.
