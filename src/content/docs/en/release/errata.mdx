...
- If switching to the SDDM greeter, there is no Ultramarine theme applied

### Xfce Edition

- The greeter may show a black wallpaper on upgrade
...
- Nvidia and Surface users may experience a kernel panic after upgrade.
  ...
  Since Ultramarine 42, only 2 kernel versions are kept, and `dracut-strip-trigger` should be installed by default.
