...
<Alert type="info">
This issue has been addressed upstream in the <a href="https://github.com/rpm-software-management/dnf-plugins-core/pull/463">following pull request</a> <br /> It will be included in the next release of dnf-plugins-core after 4.3.1.
