...
Ultramarine Linux's primary goal is to create a instantly useable experience while keeping up with innovations in the space, these are the standards we try to hold ourselves to:
...
It should be noted a new Ultramarine desktop edition is rare. If is a new desktop in the Linux space, that doesn't mean Ultramarine will immediately, or ever, adopt it, as new desktop editions require a lot of planning, development, testing, etc.
...
However, Ultramarine Linux includes Terra, RPMFusion and Flathub.
