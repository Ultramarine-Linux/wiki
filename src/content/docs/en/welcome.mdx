...
Updates with breaking changes are rolled out only for every release version.
Normal updates usually include bug fixes and some new features, but they should not break backwards compatibility.
...
- Performance
  - Windows bloat your computer with many different potentially unwanted programs that slow down your computer. Ultramarine does not.
  - Ultramarine provides a few lightweight desktop environments (namely Budgie/Flagship and XFCE), which run faster and provides a snappier experience.
  - Ultramarine uses newer technologies that are not available on Windows due to backwards compatibility. These technologies brings better performance.
...
- Stability
  ...
  - When there is a chance a system upgrade could break your computer, we warn you about it.
    - We explicitly advice people to contact support to check if the upgrade could actually break the system.
    - Our support team can help you solve any potential issues when you would like to perform a system upgrade.
...
- Customizations and Usability
  ...
  - Ultramarine comes with a software centre. You can install programs reviewed by dedicated teams very easily.
    - In fact, we do not recommend you to ever go online to find download buttons for any particular Linux programs.
    - If you want some programs to be included in the software centre, you should send us a feedback.
