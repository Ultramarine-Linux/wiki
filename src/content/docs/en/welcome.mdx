...
The phrase "just works" have a lot of implications on the ideology (or
...
**RDMS** (Readymade installer, Taidan OOBE, Katsu image builder, …),
**Terra Stack** (Andaman, Subatomic, Tetsudou, …), and
**UMSS** (Ultramarine Hop, umdive, mkfstab, …) are very clear examples:
...
With the work done in and around the Ultramarine ecosystem (XDG accent colours, Chromebook support, etc.),
the larger Linux ecosystem is improved, benefiting different users and developers in the space.
...
Ultramarine Linux also has one of the best internationalisation (i18n) support across the Linux ecosystem.
