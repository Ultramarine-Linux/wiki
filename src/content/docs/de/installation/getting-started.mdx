...
Ultramarine Linux supports Intel and AMD (amd64/x86_64) and ARM computers. Despite supporting ARM computers, Ultramarine Linux **_DOES NOT_** support M1 and M2 Macs.
