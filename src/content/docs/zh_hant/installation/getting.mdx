...
- **Budgie**（即 Budgie）︰我們最受歡迎的版本，適合追求一個熟悉及酷的系統的使用者。
- **Plasma**︰我們第二最受歡迎的版本，適合追求一個容易改製的體驗的使用者。
...
您亦可以使用 [Fedora Media Writer](https://github.com/FedoraQt/MediaWriter)，或在 Budgie、Xfce 及 GNOME 版本上的硬盤工具。
